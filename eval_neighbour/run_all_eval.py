...
# Examples: 'vit_CRPS_n0', 'vit_CRPS_n1', 'vit_CRPS_spectral_n3'
params = {
    'MODEL_NAME': os.getenv('MODEL_NAME', 'vit_CRPS_n0')
}
...
def main():
    ...
    figs_path = '/gpfs/projects/meteo/WORK/gonzabad/test-deep4downscaling/eval_neighbour/figs'
